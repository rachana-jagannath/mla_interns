...
public class TestDemo {
	public static void main(String[] args) {
		...
		Student std=ctx.getBean("std",Student.class);
				...
				Expression ex=exp.parseExpression("'Simple MLA coders Spring EL examples'");
				String dt=ex.getValue(String.class);
				System.out.println(dt+" literals ");
				Expression ex1=exp.parseExpression("'Simple MLA coders Spring EL examples'".toUpperCase());
